...
const {fsInit, getStoragePath} = require("../preload/fs/fsAPICalls");

// /**
//  * run before the test begin
//  */
// beforeAll(() => {
//
// });
...
/**
 * Check initial stage of getAllPlaylists() (without any playlist inside)
 */
test('Check getAllPlaylists() Initial Stage', async ()=>{
...
//     const str_playlist = JSON.stringify(await functions_playlist.getAllPlaylists());
//     expect(str_playlist).toBe('[\"Adding Playlist\"]');
// });
